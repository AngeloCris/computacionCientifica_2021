...
* Imprimir el siguiente mensaje "Cuando el valor de inicio sea menor a 5, detener operación" donde la variable "límite" es igual a 5 y la variable "inicio", 0.
...
```{r}
#while (inicio < limite) {
  #print("Cuand el valor de inicio sea menor a límite, detenerse")
  #inicio <- inicio + 1
#}
```
