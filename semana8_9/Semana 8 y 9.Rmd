...
Para determinar el total de filas de mi data frame usamos la funció *length*.
...
- Crear una columna denominada "sexo" que reemplace las categorias de la columna "sex". Considere lo siguiente 
